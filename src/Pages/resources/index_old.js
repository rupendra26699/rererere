...
import { FETCH_ALL_EMPLOYEES_QUERY_KEY, SEARCH_EMPLOYEE_QUERY_KEY } from "../../Constants/apiConstants";
...
const Employee = () => {
	...
	const { isLoading: isSearchLoading, isError: isSearchError, data: searchQueryData, error: searchQueryError } = useQuery(
	...
	!isLoading &&
		!error &&
		data.data.data.data.forEach((view) => {
